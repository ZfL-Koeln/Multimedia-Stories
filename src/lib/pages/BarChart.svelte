<script>
    import img02 from "$lib/assets/img/Illu2.svg";
    import datenerhebung from "$lib/assets/img/datenerhebung-weichenstellung.png";
</script>

<section id="page-11" class="page-container bg-gradient-pink"
         data-scrollspy="Wie profitieren Schüler*innen?" style="margin-top: -1px; min-height: 100%;">
    ...
    <img src="{img02}" class="max-w-[length:90%] mx-auto" alt="Illustration 01">
    <img src="{datenerhebung}" alt="Datenerhbebung Förderunterricht" class="pt-6 max-w-[length:90%] md:max-w-[length:70%] mx-auto">
