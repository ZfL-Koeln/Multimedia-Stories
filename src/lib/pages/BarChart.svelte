<script>
    import datenerhebung from "$lib/assets/img/datenerhebung-weichenstellung.svg";
</script>

<section id="page-11"
         class="page-container bg-gradient-pink"
         data-scrollspy="Wie profitieren Schüler*innen?"
         style="margin-top: -1px; min-height: 100%; padding-top: 20px;">
