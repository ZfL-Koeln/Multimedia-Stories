            ...
            <div class="bg-white text-md xl:text-xl text-center font-medium font-roboto flex flex-col justify-center p-2"
                ...
                <div class="mt-12 md:mt-14 w-full flex justify-center" style="margin-top: 30px;">
                    <button on:click={closeModal}
                            class="bg-white hover:bg-gray-300 active:bg-gray-800 active:text-white ring-2 outline-1 outline-white ring-gray-700 border-2 border-gray-200 text-xl rounded-full px-6 py-2 mb-4 transition-colors duration-200">
                        Schließen
                    </button>
                </div>
            </div>
