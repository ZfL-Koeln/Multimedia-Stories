<section id="page-12" class="flex flex-col-reverse lg:flex-row h-screen page-container"  data-scrollspy="Astrid Krämer">
	<div class="w-full h-full lg:w-7/12 px-16">
		...
		<p class="font-roboto text-2xl 2xl:text-2xl">
	...
	<div class="w-full lg:w-5/12 flex justify-center">
		<p class="text-3xl text-center lg:text-right md:text-4xl xl:text-5xl 2xl:text-6xl mx-auto font-sans font-extrabold py-12 lg:px-16 lg:pt-32">
